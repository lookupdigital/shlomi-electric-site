...
-- anything already saved in the admin is kept. Safe to run more than once. Requires migrations 1–6.
...
update public.site_settings
   set business_name            = coalesce(business_name, 'שלומי בארון - שירותי חשמל ועבודות בנייה ושיפוצים'),
       ...
       service_area             = coalesce(service_area, 'בעיקר גוש דן, וכן אזורים סמוכים בצפון ובדרום'),
